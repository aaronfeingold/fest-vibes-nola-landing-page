          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  { icon: MapPin, text: "Discover local venues and hidden gems" },
                  { icon: Users, text: "Coordinate plans with your friend group" },
                  { icon: Calendar, text: "Create multi-day festival itineraries" },
                  { icon: TrendingUp, text: "Get personalized music recommendations" },
                  { icon: Clock, text: "Optimize timing for multiple events" },
                  { icon: Star, text: "Track your favorite artists and venues" },
                ].map((item, index) => (
